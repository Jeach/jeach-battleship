...
!(function (n) {
   ...
   function x(t, e, n, a) {
      for (var r = t.aoData.length, o = P.extend(!0, {}, w.models.oRow, { src: n ? 'dom' : 'data', idx: r }), i = ((o._aData = e), t.aoData.push(o), t.aoColumns), l = 0, s = i.length; l < s; l++)
         i[l].sType = null;
   ...
   function S(t, e, n, a) {
      ...
      if (s === N)
         return (
            t.iDrawError != r &&
               null === l &&
               (W(t, 0, 'Requested unknown parameter ' + ('function' == typeof o.mData ? '{function}' : "'" + o.mData + "'") + ' for row ' + e + ', column ' + n, 4), (t.iDrawError = r)),
            l
         );
   ...
   function mt(t, e, n, a) {
      ...
      function o(t) {
         (n !== N && n !== f) ||
            ((l = d[f]),
            (s = t.innerHTML.trim()),
            l && l._bAttrSrc ? (b(l.mData._)(a, s), r(l.mData.sort, t), r(l.mData.type, t), r(l.mData.filter, t)) : h ? (l._setter || (l._setter = b(l.mData)), l._setter(a, s)) : (a[f] = s)),
            f++;
      }
      var i,
         l,
   ...
   function Lt(n) {
      function e(t) {
         ...
         (o.return && 'Enter' !== t.key) ||
            (e != o.sSearch && (Rt(n, { sSearch: e, bRegex: o.bRegex, bSmart: o.bSmart, bCaseInsensitive: o.bCaseInsensitive, return: o.return }), (n._iDisplayStart = 0), v(n)));
      }
      var t = n.oClasses,
         a = n.sTableId,
         r = n.oLanguage,
   ...
   function ee(t) {
      ...
      if (g || (!h && !l && !i && s == T(t) && s == c.length))
         ...
         for (
            b.find('thead, tfoot').remove(), b.append(P(t.nTHead).clone()).append(P(t.nTFoot).clone()), b.find('tfoot th, tfoot td').css('width', ''), c = Ct(t, b.find('thead')[0]), D = 0;
            D < u.length;
            D++
         )
            (e = r[u[D]]),
         ...
         for (
            var v = P('<div/>')
                  ...
                  .appendTo(d),
               y =
                  (l && o ? b.width(o) : l ? (b.css('width', 'auto'), b.removeAttr('width'), b.width() < d.clientWidth && f && b.width(d.clientWidth)) : i ? b.width(d.clientWidth) : f && b.width(f),
                  0),
               D = 0;
            D < u.length;
            D++
   ...
   function le(t) {
      for (var e = t.aoColumns, n = I(t), a = t.oLanguage.oAria, r = 0, o = e.length; r < o; r++) {
         ...
         u.removeAttribute('aria-sort'),
            (i = i.bSortable
               ? s +
                 ('asc' === ((0 < n.length && n[0].col == r && (u.setAttribute('aria-sort', 'asc' == n[0].dir ? 'ascending' : 'descending'), l[n[0].index + 1])) || l[0])
                    ? a.sSortAscending
                    : a.sSortDescending)
               : s),
   ...
   function fe(t, e) {
      for (
         var n, a, r, o = t.aoColumns[e], i = w.ext.order[o.sSortDataType], l = (i && (n = i.call(t.oInstance, t, e, ot(t, e))), w.ext.type.order[o.sType + '-pre']), s = 0, u = t.aoData.length;
         s < u;
         s++
      )
   ...
   function be(t, e, n) {
      ...
      for (r in e)
         e.hasOwnProperty(r) &&
            ((a = e[r]),
            P.isPlainObject(a) ? (P.isPlainObject(t[r]) || (t[r] = {}), P.extend(!0, t[r], a)) : n && 'data' !== r && 'aaData' !== r && Array.isArray(a) ? (t[r] = a.slice()) : (t[r] = a));
      return t;
   }
   function me(e, t, n) {
      P(e)
            ...
            return (
               this.iterator('row', function (t, e, n) {
                  ...
                  for (u.splice(e, 1), a = 0, r = u.length; a < r; a++)
                     if (((s = (l = u[a]).anCells), null !== l.nTr && (l.nTr._DT_RowIndex = a), null !== s)) for (o = 0, i = s.length; o < i; o++) s[o]._DT_CellIndex.row = a;
      ...
      return function (a, r, o, i) {
         ...
         return (
            ...
            function (t, e) {
               ...
               return (
                  (null !== t && t !== N) ||
                     (t = '--now' === i ? ((n = new Date()), new Date(Date.UTC(n.getFullYear(), n.getMonth(), n.getDate(), n.getHours(), n.getMinutes(), n.getSeconds()))) : ''),
                  'type' === e
                     ? l
                     : '' === t
                     ? 'sort' !== e
