...
!(function (t, e) {
         ...
         _ = function (t, e, n) {
            ...
            return b && o instanceof Blob
               ? e
                  ? n(o)
                  : A(o, n)
               : w && (o instanceof ArrayBuffer || ((r = o), 'function' == typeof ArrayBuffer.isView ? ArrayBuffer.isView(r) : r && r.buffer instanceof ArrayBuffer))
               ? e
                  ? n(o)
                  : A(new Blob([o]), n)
               : n(g[i] + (o || ''));
   ...
   var T = 'function' == typeof ArrayBuffer,
      C = function (t, e) {
         ...
         var n = t.charAt(0);
         return 'b' === n ? { type: 'message', data: B(t.substring(1), e) } : m[n] ? (t.length > 1 ? { type: m[n], data: t.substring(1) } : { type: m[n] }) : k;
      },
      B = function (t, e) {
         if (T) {
            var n = (function (t) {
   ...
   var ft = (function (n) {
      ...
      function a(n) {
         ...
         return (
            ...
            n
               ? ((n = ht(n)), (o.hostname = n.host), (o.secure = 'https' === n.protocol || 'wss' === n.protocol), (o.port = n.port), n.query && (o.query = n.query))
   ...
   function wt(e, n) {
      ...
      else if ('object' === t(e)) for (var i in e) Object.prototype.hasOwnProperty.call(e, i) && (e[i] = wt(e[i], n));
      return e;
   }
   var _t;
   !(function (t) {
            ...
            r(t, [
               {
                  ...
                  value: function (t) {
                     return (t.type !== _t.EVENT && t.type !== _t.ACK) || !gt(t)
                        ...
                        : ((t.type = t.type === _t.EVENT ? _t.BINARY_EVENT : _t.BINARY_ACK), this.encodeAsBinary(t));
                  },
               },
               {
                  key: 'encodeAsString',
                  value: function (t) {
                     var e = '' + t.type;
                     return (
                        (t.type !== _t.BINARY_EVENT && t.type !== _t.BINARY_ACK) || (e += t.attachments + '-'),
                        t.nsp && '/' !== t.nsp && (e += t.nsp + ','),
                        null != t.id && (e += t.id),
                     ...
                     value: function (t) {
                        ...
                        if ('string' == typeof t)
                           (e = this.decodeString(t)).type === _t.BINARY_EVENT || e.type === _t.BINARY_ACK
                              ? ((this.reconstructor = new Ot(e)), 0 === e.attachments && d(s(a.prototype), 'emitReserved', this).call(this, 'decoded', e))
   ...
   var Nt = (function (n) {
         ...
         function s(n, r) {
            ...
            e(this, s),
               ...
               (o.backoff = new St({ min: o.reconnectionDelay(), max: o.reconnectionDelayMax(), jitter: o.randomizationFactor() })),
   ...
   function Lt(e, n) {
      ...
      return (
         n.forceNew || n['force new connection'] || !1 === n.multiplex || c ? (r = new Nt(o, n)) : (xt[s] || (xt[s] = new Nt(o, n)), (r = xt[s])),
